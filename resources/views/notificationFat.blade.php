...
<head>
    <meta charset="UTF-8">
    <title>Novo Formulario de FAT (Familia de Acolhimento Temporario)</title>
</head>
                    ...
                    <tr>
                        <td style="padding:30px; color:#333333;">
                            ...
                            <p style="font-size:15px; line-height:1.6;">
                                Informamos que foi submetido um <strong>novo formulário de FAT</strong>.
                            </p>

                            <p style="font-size:15px; line-height:1.6;">
                                Para mais detalhes, aceda à Área Reservada e consulte a secção
                                <strong>“Pedidos FAT”</strong>.
                            </p>

                            <!-- Button -->
                            <div style="text-align:center; margin:30px 0;">
                                <a href="{{ url('/admin/fat-requests') }}"
